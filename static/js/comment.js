...
;(function($){
    $.aiyiweb.comment = {
        ...
        init: function(options){
            options && $.extend($.aiyiweb.comment.settings, options);
            $.aiyiweb.comment.list();
            $.aiyiweb.comment.publish();
        },
        //列表
        list: function(){
            var s = $.aiyiweb.comment.settings;
            $('li', $(s.page_list)).live({
                mouseover: function(){
                    $(this).addClass('hover');
                },
