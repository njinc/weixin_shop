<?php if (!defined('THINK_PATH')) exit();?><link rel="stylesheet" type="text/css" href="__STATIC__/weixin/css/dingcan/css2.css"/>
...
<script type="text/javascript" src="__STATIC__/weixin/js/dingcan/addfollows.js"></script>
<script>
	$(function(){
		$('#menu2_autoreply').show();
		$('.arrow_img_autoreply').attr('src', '__STATIC__/weixin/images/dingcan/index_20.png');
